        ...
        <div className="mt-3 mb-10 px-4">
          <div className="search_container">
            <div className="flex align-center">
              ...
              <div>
                <button
                  className="btn inline-block px-6 py-2.5 bg-gray-700 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-900 hover:shadow-lg focus:bg-gray-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
                  type="button"
                  id="button-addon2"
                >
                  <svg
              ...
              <table className="table-auto w-full">
                <thead>
                  <tr className="bg-gray-700 text-center">
                    <th className="w-1/6 min-w-[160px] text-lg font-semibold text-white py-2 lg:py-4 px-3 lg:px-4 border-l border-transparent">
                      #ID
                    </th>
                    <th className="w-1/6 min-w-[160px] text-lg font-semibold text-white py-2 lg:py-4 px-3 lg:px-4 border-l border-transparent">
                      Product Name
                ...
                <tbody>
                  {products.loading ? (
                    ...
                    searchHandler(products.data, searched).length > 0 ? (
                      searchHandler(products.data, searched).map(
                        (product: productI, key: number) => (
                          <ProductListCard
                            key={product._id + key}
                            product={product}
                          />
