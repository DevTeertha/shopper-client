  ...
  return (
    <>
      <a
        ...
        className="cursor-pointer text-green-500 font-bold decoration-1"
      >
        Edit
      </a>
      {showModal ? (
          ...
          <div className="justify-center items-center flex overflow-x-hidden h-full fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <form
                  onSubmit={(e) => editProductSubmitHandler(e)}
                  id="editProduct_form"
                >
                  <div className="relative p-6 overflow-y-scroll h-96">
                    <div className="my-4 text-blueGray-500 text-lg leading-relaxed">
                      <div className="py-3">
                        ...
                        <input
                          value={product._id}
                          className="form-control bg-gray-200 relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-gray-600 focus:outline-none"
                          type="text"
                          disabled
                        />
                      </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="py-3">
                                ...
                                <input
                                  name="variant"
                                  onBlur={(e: any) =>
                                    setVariantHandler(e, key, "variant")
                                  }
                                  defaultValue={vr.variant}
                                  className="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-gray-600 focus:outline-none"
                                  type="text"
                                />
                              </div>
