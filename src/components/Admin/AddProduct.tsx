...
const AddProduct: React.FC = () => {
  ...
  const variants: VariantI[] = [...variantState];
  ...
  const addProductSubmitHandler = (e: any) => {
    ...
    if (
      ...
      addProduct.stock &&
      variantState[0].variant.length > 0 &&
      file
    ) {
      ...
      <form id="addProduct_form" onSubmit={(e) => addProductSubmitHandler(e)}>
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-4">
            ...
            <input
              name="productName"
              onBlur={(e) =>
                setAddProudct({ ...addProduct, productName: e.target.value })
              }
          ...
          <div className="mb-4">
            ...
            <input
              onBlur={(e) =>
                setAddProudct({ ...addProduct, stock: e.target.value })
              }
              name="stock"
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="stock"
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="mb-4">
            ...
            <input
              name="description"
              onBlur={(e) =>
                setAddProudct({ ...addProduct, description: e.target.value })
              }
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-4">
            ...
            <input
              name="variant"
              onBlur={(e: any) => setVariantHandler(e, 0, "variant")}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="text"
              placeholder="Variant"
            />
          ...
          <div className="mb-4">
            ...
            <input
              name="price"
              onBlur={(e: any) => setVariantHandler(e, 0, "price")}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="text"
              placeholder="Price"
            />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-4">
            ...
            <input
              name="variant"
              onBlur={(e: any) => setVariantHandler(e, 1, "variant")}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="text"
              placeholder="Variant"
            />
          ...
          <div className="mb-4">
            ...
            <input
              name="price"
              onBlur={(e: any) => setVariantHandler(e, 1, "price")}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="text"
              placeholder="Price"
            />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-4">
            ...
            <input
              name="variant"
              onBlur={(e: any) => setVariantHandler(e, 2, "variant")}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="text"
              placeholder="Variant"
            />
          ...
          <div className="mb-4">
            ...
            <input
              name="price"
              onBlur={(e: any) => setVariantHandler(e, 2, "price")}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="text"
              placeholder="Price"
            />
        ...
        <div className="mt-4">
          {addProductState.loading ? (
            <button
              type="submit"
              className="cursor-not-allowed bg-emerald-500 hover:bg-emerald-700 text-white font-bold rounded px-10 py-2"
            >
              <svg
                role="status"
            ...
            <button
              type="submit"
              className="bg-emerald-500 hover:bg-emerald-700 text-white font-bold rounded px-10 py-2"
            >
              Add Product
            </button>
          )}
