                ...
                <div className='w-full max-w-md m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-10 px-16'>
                    ...
                    <form id='register_form' onSubmit={(e: React.SyntheticEvent) => registerHandler(e)}>
                        ...
                        <div className='flex justify-center items-center mt-6'>
                            {
                                login.loading ? <button type="button" className="w-full cursor-not-allowed w-100 bg-emerald-700 py-2 px-4 text-sm text-white rounded border border-green focus:outline-none focus:border-green-dark" disabled>
