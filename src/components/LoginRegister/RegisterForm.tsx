    ...
    <div className="container mx-auto px-4">
      <div className="h-screen flex bg-gray-bg1">
        <div className="w-full max-w-md m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-10 px-16">
          ...
          <form
            id="register_form"
            onSubmit={(e: React.SyntheticEvent) => registerHandler(e)}
          >
            <div>
              <label htmlFor="name">Name</label>
              <input
                onBlur={(e: React.ChangeEvent<HTMLInputElement>) =>
                  registerInfoChangeHandler(e)
                }
                name="name"
                type="text"
                className={`w-full orm-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid ${
                  isEmptyRegisterInfo.name
                    ? "border-red-500 focus:border-red-500"
                    : "border-gray-300 focus:border-emerald-600"
                } rounded transition ease-in-out m-0 focus:text-gray-700 focus:outline-none`}
                id="name"
            ...
            <div className="pt-5">
              ...
              <input
                ...
                type="password"
                className={`w-full orm-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid ${
                  isEmptyRegisterInfo.confirm_password
                    ? "border-red-500 focus:border-red-500"
                    : "border-gray-300 focus:border-emerald-600"
                } rounded transition ease-in-out m-0 focus:text-gray-700 focus:outline-none`}
                id="confirm_password"
