...
const CartList = () => {
    ...
    const placedOrderHandler = () => {
        if (getStorage('userToken')) {
            ...
            dispatch(placeOrderAction(userToken, cartState.totalPrice, cartState.cartItems, "processing"));
        }
    }
            ...
            <div className='py-3'>
                {
                    cartState.cartItems.length > 0 ? <div>
                        ...
                        <div className="py-5 text-center">
                            {
                                placeOrderState.loading ? <button onClick={() => placedOrderHandler()} className="cursor-not-allowed bg-emerald-500 hover:bg-emerald-700 font-bold text-2xl text-white rounded px-5 py-2">
