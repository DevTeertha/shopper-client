  ...
  return (
    <div className="border-b border-gray-300 pb-4">
      <div className="flex justify-between items-center">
        <div className="w-3/6">
          <div className="flex">
            ...
            <div className="p-3">
              ...
              <p className="my-3">
                Variant:{" "}
                <span className="inline-block rounded px-3 border border-gray-400">
                  {selectVariant}
                </span>
              </p>
            </div>
        ...
        <div className="p-3">
          <button
            onClick={() => dispatch(removeToCart(_id))}
            className="bg-red-500 hover:bg-red-700 py-2 px-3 text-white rounded"
          >
            Remove
          </button>
        </div>
