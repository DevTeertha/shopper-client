...
import { cartItemI, VariantI } from '../../src/interfaces/ProductsInterface';
...
const ProductDetails: React.FC = () => {
  ...
  const placeOrderState: any = useSelector((state: any) => state.placeOrderReducer);
              ...
              <div className='sm:w-full md:w-2/6 p-4'>
                ...
                </div>
                {
                  parseInt(stock) > 0 ? <div className='flex py-3'>
                    ...
                    {
                      placeOrderState.loading ? <div className='ml-5'>
                        <button onClick={(e: any) => buyNowHandler()} className='cursor-not-allowed hover:bg-red-700 bg-red-500 text-white font-bold px-5 py-2 rounded'>
                        ...
                        <button onClick={(e: any) => buyNowHandler()} className='hover:bg-red-700 bg-red-500 text-white font-bold px-5 py-2 rounded'>Buy Now</button>
                      </div>
                    }
